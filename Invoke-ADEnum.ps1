...
"
	...
	Write-Host ""
	$Keywords = @("Admin", "Azure", "Backup", "CCTV", "Cyber", "Desk", "Director", "Finance", "Hyper", "JEA", "LAPS", "LLMNR", "Management", "MECM", "Mgmt", "Password", "PAM", "PAW", "PPL", "PSM", "Remote", "Remoting", "SCCM", "Security", "SQL", "VEEAM", "VMWare")
